...
If the core idea is abstract, LEAD WITH A CONCRETE, TANGIBLE EXAMPLE (a specific case, a small code snippet, or a broken output) and only then generalize to the principle — never present the abstraction before the example. Examples are your primary tool for making complex ideas clear.
